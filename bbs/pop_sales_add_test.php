...
<div class="new_win">
    ...
    <form name="fitemexcel" method="post" action="./pop_sales_add_update_test.php" enctype="MULTIPART/FORM-DATA" autocomplete="off" onsubmit="return chkfrm(this)" >
  ...
  alert("테스트 페이지입니다.");
	...
	$('#domain').bind('change', function(){
		...
		if(domain == "Qoo10" || domain == "qoo10-jp" || domain == "Qoo10-1" || domain == "qoo10jp-1") {
			...
			f.action = './pop_sales_add_update_test.php';
		}
