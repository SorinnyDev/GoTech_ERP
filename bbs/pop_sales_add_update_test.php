...
//			$wr_14             		 = $total_price - $taxrate; //신고가격 (totalprice - 이베이수수료)
      ...
      if ($shippingmethod == "Expedited Shipping") {
        $wr_20 = "0001";
      } else {
        $wr_20 = "0002";
      }
    ...
    $chk = sql_fetch("select * from  {$write_table} where wr_subject LIKE '%$wr_subject%' and wr_16 = '{$wr_16}' and wr_17 = '{$wr_17}' and wr_10 = '{$wr_10}' ");
