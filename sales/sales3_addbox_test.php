...
if($first == 1 && $hap_chk) {
  ...
  <div class="tbl_frm01 tbl_wrap" style="margin:0">
    ...
    <table style="margin-top:20px">
      ...
      <!-- 배송정보 -->
      <tr>
        <th class="title" rowspan="11">배송정보</th>
        <th>수령자명</th>
        <td>
      ...
      <tr id="delivery_area">
        ...
        <th>배송요금</th>
        <td><input type="text" name="wr_delivery_fee" id="wr_delivery_fee" value="<?=$row['wr_delivery_fee']?>"></td>
        <th>추가배송비</th>
  ...
  <div class="tbl_frm01 tbl_wrap" style="margin:0">
    ...
    <table>
      ...
      <tr>
        ...
        <th>발주단가</th>
        <td>
          <input type="text" name="wr_order_price" value="<?=(!$row['wr_order_price'])?$item['wr_22']:$row['wr_order_price']?>" class="input_frm readonly" readonly/>
        </td>
        <th>배송비</th>
        <td>
        ...
        <th>발주금액</th>
        <td>
          <input type="text" name="wr_order_total" value="<?=(!$row['wr_order_total'])?($item['wr_22']*$row['wr_ea']):$row['wr_order_total']?>" class="input_frm readonly" readonly/>
        </td>
        <td colspan="2"></td>
      </tr>
      <!--// 발주정보 -->
...
<script>
  ...
  function etc_update(){
    ...
    $.post(g5_url+"/sales/ajax.etc_update.php",{seq:seq,wr_release_etc:wr_release_etc},function(data){
      if(data=='y'){
