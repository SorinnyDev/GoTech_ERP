...
<style>
.cnt_left {padding:5px 10px; border-right:1px solid #ddd; word-break: break-all; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;}
...
for ($i = 0; $row = sql_fetch_array($rst); $i++) {
    ...
    ?>
		            <li class="modify" data="<?php echo $row['seq']?>">
						...
						<?php if ($is_admin) {
						    echo '<strong style="color:red">'.$sales2['wr_date3'].'</strong>';
						}?>
						</div>
...
<?php
    ...
    ?>
										<div class="cnt_left" style="width:100px;text-align:right"><?php echo $row['wr_safe_ea'] ?></div>
...
$(function() {
	...
	$('.modify').bind('click', function() {
		...
		$.post('./sales1_addbox_test2.php', { seq : id }, function(data) {
...
function export_excel(){
    ...
    document.location.href="./sales1_excel_test2.php?"+params+"&"+params2;
}
