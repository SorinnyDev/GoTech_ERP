...
.tbl_frm01 th {background:#6f809a;color:#fff;border:1px solid #60718b;font-weight:normal;text-align:center;padding:8px 5px;font-size:0.92em; width:100px}
...
<table>
	...
	<tr>
		...
		<th>발주처</th>
		<td>
		<select name="wr_orderer" class="search_sel" required>
...
$(document).ready(function() {
	...
	$(document).on('keyup', '.add_wr_order_ea, .add_wr_order_price, .add_wr_order_fee', function(){
		...
		console.log(isNaN(ea));
		
		// if(!isDefined(ea)){
		// 	ea = 0;
		// 	$(".add_wr_order_ea").val(0);
		// }
