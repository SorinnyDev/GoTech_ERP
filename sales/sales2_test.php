	    ...
	    <div id="bo_li_01" style="overflow-x:scroll;height:400px">
	        ...
	        <div id="bo_li_01" class="list_03">
		        <ul style="width:3500px">
					...
					$sql = "select * from g5_sales2_list where (1) {$sql_search} and wr_direct_use = 0 order by seq desc";
		            ...
		            <li class="modify" data="<?php echo $row['seq']?>">
		                ...
		                <div class="num cnt_left" style="width:70px"><?php echo ($i+1) ?><?=$wr_warehouse_etc?></div>
		                ...
		                <div class="cnt_left" style="width:150px;text-align:center;<?php echo $imsi_item ?>"><?php echo $row['wr_code'] ?></div>
		                
		                <div class="cnt_left" style="width:150px;"><?php echo $item['wr_2'] ?></div>
		                <div class="cnt_left" style="width:250px;<?php echo $imsi_item ?>"><?php echo $row['wr_product_nm'] ?></div>
...
$(function() {
	...
	$('.modify').bind('click', function() {
		...
		$.post('./sales2_addbox.php', { seq : id }, function(data) {
