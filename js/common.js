...
function HttpJson(url,type,obj){
    let return_obj;
...
/**********************************************
*문자열에서 숫자만 가져가기
*숫자 음수 추가 abs_chk = true 일경우 음수 가능
**********************************************/
function get_number(str, abs_chk){
	var val = str;
	var temp = "";
	var num = "";
	if(isDefined(abs_chk) == false) abs_chk = false;
...
/**********************************************
*배송구분(service type) 명칭 가져오기
**********************************************/
function fnGetServiceType(code){
	var code_name = "";
	if(code == "0001"){
		code_name = "특송";
	}else if(code == "0002"){
