...
// echo "SELECT SUM(wr_32) as kor, SUM(wr_36) as usa, SUM(wr_37) as tmp, SUM(wr_42) as fba , SUM(wr_43) as wfba , SUM(wr_44) as ufba  {$sql_common} WHERE (1) {$sql_add} ";
?>
	...
	<div class="bo_list_innr">
	    ...
	    <div id="bo_li_top_op">
			...
			<ul class="<?php echo isset($view) ? 'view_is_list btn_top' : 'btn_top2';?>">
			    ...
			    <!-- <li><button type="button" class="btn_b01 rack_form">창고별 랙 관리</button></li> -->
			</ul>
		</div>
	        ...
	        <div id="bo_li_01" class="list_03" >
		        <ul style="width:100%;">
		            ...
		            <li class="modify" data="<?php echo $row['seq']?>">
		                ...
		                <div class="cnt_left" style="width:400px;" title="<?php echo $row['wr_subject'] ?>"><?php echo $row['wr_subject'] ?></div>
