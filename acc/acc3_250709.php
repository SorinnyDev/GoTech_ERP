...
<div class="bo_sch_wrap">
	<fieldset class="bo_sch" style="padding:10px">
		...
		<form name="fsearch" method="get">
			...
			<div style="margin-top: 10px">
				<input type="radio" name="ledger" id="all" value="all" <?= ($all === 'Y' || !isset($_POST['ledger'])) ? "checked" : "" ?>>
				<label for="all" style="margin-right: 10px;">전체</label>

				<input type="radio" name="ledger" id="account" value="account" <?= $account === 'Y' ? "checked" : "" ?>>
				<label for="account" style="margin-right: 10px;">매출만</label>

				<input type="radio" name="ledger" id="receipt" value="receipt" <?= $receipt === 'Y' ? "checked" : "" ?>>
