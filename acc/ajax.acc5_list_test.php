...
if($wr_domain != ""){
	...
	//$sql_where .= " AND (A.wr_ori_order_num = '#36114' or A.wr_ori_order_num = '#36129' or A.wr_ori_order_num = '#36322' or A.wr_ori_order_num = '#36470' )  ";

	//$sql_where .= " AND (A.wr_ori_order_num = '#36575')  ";

	//$sql_where .= " AND (A.wr_ori_order_num = '#36285')  ";

	//$sql_where .= " AND (A.wr_ori_order_num = '#36505')  ";

	//$sql_where .= " AND (A.wr_order_num = '#36505F')  ";
