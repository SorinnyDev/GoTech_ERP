      ...
      <form name="fboardlist" id="fboardlist" action="<?php echo G5_URL; ?>/acc/acc3_list_update.php"
        ...
        <div id="bo_li_top_op">
          ...
          <ul class="<?php echo isset($view) ? 'view_is_list btn_top' : 'btn_top2'; ?>">
            ...
            <li><button type="button" class="btn_b01 btn_bo_sch"><i class="fa fa-search"
                                                                    aria-hidden="true"></i>검색</button></li>
            <li><button type="submit" name="btn_submit" value="선택정산완료" class="btn_b02 "
                        style="background:#8e74ef;color:white;"><i class="fa fa-file-pdf-o"></i> 선택정산완료</button></li>
            <li><button type="submit" name="btn_submit" value="선택정산취소" class="btn_b02 "><i class="fa fa-file-pdf-o"></i>
                선택정산취소</button></li>
...
//                                $remainingAmount = $remainingAmount < 0 ? 0 : $remainingAmount;
                              ...
                              <tr class="<?= $tr ?>">
                                ...
                                <td><?= $item['wr_ea'] ?></td>
                                <td><?= number_format($item['wr_danga'], 2) ?></td>
                                <td><?= number_format($item['wr_singo'], 2) ?></td>
                                <td>
                                  <label>
                                ...
                                <td>
                                  ₩<span class="remaining-amount"
                                         data-remaining="<?= $remainingAmount ?>"><?= number_format($remainingAmount) ?></span>
                                </td>
                                <td align="center">
                ...
                <?php } else if ($search_accumulate !== 'Y') { ?>
                    <?php if (!$sc_domain) { ?>
                    <tr>
              ...
              <table>
                ...
                <?php if (sql_num_rows($result) > 0) {
                  ...
                  <tr>
                    ...
                    <td style="text-align: left !important;"><?= number_format($total_tax, 2) ?></td>
                    <td style="text-align: left !important;"><?= number_format($total_remainingAmount, 2) ?></td>
                  </tr>
