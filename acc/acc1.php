...
if ($search_warehouse) {
  $sql_where .= " AND G2.wr_warehouse = '$search_warehouse' ";
}
      ...
      <form name="fsearch" method="get">
        ...
        <div style="border:1px solid #ddd; margin-bottom:20px; padding:10px">
          <select name="search_warehouse" id="search_warehouse" class="frm_input search_sel" style="width: 100%;">
            ...
            <option value="1000" <?= get_selected($search_warehouse, '1000') ?>>한국창고</option>
            <option value="3000" <?= get_selected($search_warehouse, '3000') ?>>미국창고</option>
            <option value="4000" <?= get_selected($search_warehouse, '4000') ?>>FBA창고</option>
            <option value="5000" <?= get_selected($search_warehouse, '5000') ?>>W-FBA창고</option>
            <option value="6000" <?= get_selected($search_warehouse, '6000') ?>>U-FBA창고</option>
            <option value="9000" <?= get_selected($search_warehouse, '9000') ?>>임시창고</option>
          </select>
        </div>
        <div style="border:1px solid #ddd; margin-bottom:20px; padding:10px">
