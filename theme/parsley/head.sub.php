...
?>
<title><?php echo "[운영]".$g5_head_title; ?></title>
...
add_javascript('<script src="'.G5_JS_URL.'/jquery.form.js"></script>', 0);
...
//add_javascript('<script src="'.G5_THEME_JS_URL.'/mui.min.js"></script>', 1);
