...
<div id="mb_login" class="mbskin" style="border:1px solid #777">
    <h1><img src="/img/DODOlogistics_logo.png" style="width:50%"></h1>
	<div class="mbskin_inner">
        ...
        <fieldset id="login_fs">
            ...
            <span class="login_auto">
				<input type="checkbox" name="auto_login" id="login_auto_login2">
                <label for="login_auto_login2" id="login_auto_lb">자동로그인</label>
