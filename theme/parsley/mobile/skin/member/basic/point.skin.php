...
<div id="point" class="new_win">
    ...
    <div class="new_win_con">
    	<p class="point_all">
        	<span class="point_all_tit">보유예치금</span>
    ...
    //            if($row['po_expired'] == 1)
        ...
        <div class="point_status">
            <p class="point_status_add"><span>지급예치금</span><b class="sum_val"><?php echo $sum_point1; ?></b></p>
            <p class="point_status_sbt"><span>사용예치금</span><b class="sum_val"><?php echo $sum_point2; ?></b></p>
        </div>
