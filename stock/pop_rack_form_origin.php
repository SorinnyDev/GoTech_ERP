...
<div class="new_win">
	...
	<div id="excelfile_upload" class="result_list" style="padding:12px;">
		...
		<div class="tbl_head01 tbl_wrap" style="width:24%;max-height:550px;overflow-y:scroll;margin-right:0.5%;float:left">
            <table>
                <thead style="position:sticky;top:0;">
                    <tr>
                        <th style="width:100%" colspan="3"><strong>한국창고</strong></th>
                    </tr>
                    <tr >
                        <th>랙 이름</th>
                        <th>총 재고</th>
		...
		<div class="tbl_head01 tbl_wrap" style="width:24%;max-height:550px;overflow-y:scroll;margin-right:0.5%;float:left">
            <table>
                <thead style="position:sticky;top:0;">
                    <tr>
                        <th style="width:100%" colspan="3"><strong>미국창고</strong></th>
                    </tr>
                    <tr>
                        <th>랙 번호</th>
                        <th>총 재고</th>
		...
		<div class="tbl_head01 tbl_wrap" style="width:24%;max-height:550px;overflow-y:scroll;margin-right:0.5%;float:left">
            <table>
                <thead style="position:sticky;top:0;">
                    <tr>
                        <th style="width:100%" colspan="3"><strong>한국 반품창고</strong></th>
                    </tr>
                    <tr>
                        <th>랙 번호</th>
                        <th>총 재고</th>
		...
		<div class="tbl_head01 tbl_wrap" style="width:24%;max-height:550px;overflow-y:scroll;float:left">
            <table>
                <thead style="position:sticky;top:0;">
                    <tr>
                        <th style="width:100%" colspan="3"><strong>미국 반품창고</strong></th>
                    </tr>
                    <tr>
                        <th>랙 번호</th>
                        <th>총 재고</th>
