...
$query = "
select b.id, b.box_code, b.reg_datetime, b.is_transfer, sum(wr_ea) as 'wr_ea',
       case
...
where (1) and b.reg_datetime between '$st_date 00:00:00' and '$ed_date 23:59:59' {$where}
group by b.id
        ...
        <div class="tbl_head01 tbl_wrap">
          <table>
            ...
            <tr>
              ...
              <th style="width: 220px;">미국 수령일자</th>
            ...
            <tr>
              ...
              <td>
                <?php if ($item['is_transfer']) { ?>
                  <a href="#" class="btn btn_b02" style="background: #f2f2f2;">이관완료</a>
                <?php } else { ?>
                  <a href="#" onclick="processBox('<?= $item['id'] ?>')" class="btn btn_b01">이관진행</a>
                <?php } ?>
