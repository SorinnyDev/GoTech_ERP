...
// $timestamp_2025_07_01 = strtotime('2025-07-01');
// define('G5_SERVER_TIME', $timestamp_2025_07_01);
...
$storage_arr = array();
# 한국 창고
$storage_arr['1000']['field'] = "wr_32";
$storage_arr['1000']['field_real'] = "wr_32_real";
$storage_arr['1000']['code_nm'] = "한국창고";

#미국 창고
$storage_arr['3000']['field'] = "wr_36";
$storage_arr['3000']['field_real'] = "wr_36_real";
$storage_arr['3000']['code_nm'] = "미국창고";

# FBA창고
$storage_arr['4000']['field'] = "wr_42";
$storage_arr['4000']['field_real'] = "wr_42_real";
$storage_arr['4000']['code_nm'] = "FBA창고";

# W-FBA창고
$storage_arr['5000']['field'] = "wr_43";
$storage_arr['5000']['field_real'] = "wr_43_real";
$storage_arr['5000']['code_nm'] = "W-FBA창고";

# U-FBA창고
$storage_arr['6000']['field'] = "wr_44";
$storage_arr['6000']['field_real'] = "wr_44_real";
$storage_arr['6000']['code_nm'] = "U-FBA창고";

# 한국반품창고
$storage_arr['7000']['field'] = "wr_40";
$storage_arr['7000']['field_real'] = "wr_40_real";
$storage_arr['7000']['code_nm'] = "한국반품창고";

# 미국반품창고
$storage_arr['8000']['field'] = "wr_41";
$storage_arr['8000']['field_real'] = "wr_41_real";
$storage_arr['8000']['code_nm'] = "미국반품창고";

#임시창고
$storage_arr['9000']['field'] = "wr_37";
$storage_arr['9000']['field_real'] = "wr_37_real";
$storage_arr['9000']['code_nm'] = "임시창고";

#한국폐기창고
$storage_arr['11000']['field'] = "wr_45";
$storage_arr['11000']['field_real'] = "wr_45_real";
$storage_arr['11000']['code_nm'] = "한국폐기창고";

#미국폐기창고
$storage_arr['12000']['field'] = "wr_46";
$storage_arr['12000']['field_real'] = "wr_46_real";
$storage_arr['12000']['code_nm'] = "미국폐기창고";


# 유통상품 플랫폼 배열( 배열에 포함되지 않는 플랫폼은 모두 화장품 )
$circulation = array('Ebay','WM','AC','AJP');

# 배송구분
$service_arr = array();
$service_arr['0001'] = "특송";
$service_arr['0002'] = "일반배송";
$service_arr['0003'] = "STD";
$service_arr['0006'] = "shipter";
$service_arr['0007'] = "JP";
