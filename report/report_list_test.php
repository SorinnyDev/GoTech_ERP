      ...
      <form name="fboardlist" id="fboardlist" action="<?php echo G5_BBS_URL; ?>/board_list_update.php"
        ...
        <div id="bo_li_top_op">
          ...
          <ul class="<?php echo isset($view) ? 'view_is_list btn_top' : 'btn_top2'; ?>">
            ...
            <!--<li><button type="button" class="btn_b01 mb_write_btn" data="<?= $report_mb_id ?>" style="margin:10px;" >담당자별 실사재고조사</button></li>-->
            <li>
            ...
            <ul style="width:100%;">
                ...
                for ($i = 0; $row = sql_fetch_array($rst); $i++) {
                  ...
                  <li class="modify" data="<?php echo $row['seq'] ?>">
                    <div class="num cnt_left" style="width:100px"><?php echo abs($cur_no) ?></div>
                    ...
                    <div class="cnt_left" style="width:100px" title="<?php echo $row['wr_1'] ?>">
                        <?php echo $row['wr_1'] ?>
                    </div>
                    <div class="cnt_left" style="width:200px; border-right: unset;"
                         title="<?php echo $row['wr_subject'] ?>"><?php echo $row['wr_subject'] ?></div>
                    <div class="cnt_left" style="width:200px;text-align:center;border-left: 1px solid #ddd;">
    ...
    <fieldset class="bo_sch">
      ...
      <form name="fsearch" method="get">
        ...
        <div style="border:1px solid #ddd; margin-bottom:20px; padding:10px">
          <select name="search_wr_26" id="search_wr_26" class="frm_input search_sel">
